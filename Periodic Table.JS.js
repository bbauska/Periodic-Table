// This is the data array.  It is like a read-only database.
const elements = [
  {
    name: "Hydrogen",
...
function makeTable() {
  for(let i = 0; i < elements.length; i++) {
    // You can see the HTML I made in this function
    let element = `<div class="element" id="${elements[i].symbol}" name="${elements[i].category}">
    <div id="number">${elements[i].number}</div>
    <div id="symbol">${elements[i].symbol}</div>
    <div id="name">${elements[i].name}</div>
    <div id="atomic-mass">${elements[i].atomic_mass}</div>
  </div>`;
    
    // I append each element to the table I ACCESSED above
    table.innerHTML += element;
    
    // Use JavaScript to make all the CSS for grid-area
    // const cssDIV = document.querySelector('#css');
    // let css = `#${elements[i].symbol} { grid-area: ${elements[i].symbol}; }`;
    // cssDIV.textContent += css;
  }
}

// Call the function.  The table is made.
makeTable();



// One way to color backgrounds using JavaScript
// const elemShapes = document.querySelectorAll('.element');
// elemShapes.forEach(el => {
//   switch(el.getAttribute('name')) {
//       case "alkali metal":
//       el.style.backgroundColor = "#F2A922";
//       break;
//       case "noble gas":
//       el.style.backgroundColor = "#BF861B";
//       break; 
//       case "alkaline earth metal":
//       el.style.backgroundColor = "silver";
//       break; 
//       case "transition metal":
//       el.style.backgroundColor = "#FFBB3D";
//       break; 
//       case "diatomic nonmetal":
//       el.style.backgroundColor = "#BF861B";
//       break;
//       case "post-transition metal":
//       el.style.backgroundColor = "#BFA408";
//       break;
//       case "lanthanide":
//       el.style.backgroundColor = "#08B9BF";
//       break;
//       case "metalloid":
//       el.style.backgroundColor = "#9BB5A5";
//       break;
//       case "polyatomic nonmetal":
//       el.style.backgroundColor = "#B1CDF0";
//       break;
//       case "actinide":
//       el.style.backgroundColor = "#B1CDF0";
//       break;
//       default:
//       el.style.backgroundColor = "#F0DAB1";
//   }
// });
